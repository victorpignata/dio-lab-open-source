...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/victorpignata`;
    > Exemplo: `git checkout -b feat/community/victorpignata`
